...
cat ALL.$project.cnv.tsv | cut -f5,14,15 | tail -n +2 >  ALL.$project.methylation.to_fetch.tsv
...
cat ALL.$project.Tx_profile.tsv | cut -f5,14,15 | tail -n +2 >  ALL.$project.Tx_profile.to_fetch.tsv
...
cat ALL.$project.maf.tsv | cut -f5,633,634 | tail -n +2 >  ALL.$project.maf.to_fetch.tsv
...
cat ALL.$project.biospecimen.tsv | cut -f5,177,178 | tail -n +2 >  ALL.$project.biospecimen.to_fetch.tsv
...
cat ALL.$project.clinical.tsv | cut -f5,177,178 | tail -n +2 >  ALL.$project.clinical.to_fetch.tsv
